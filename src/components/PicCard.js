...
import editPicture from "../feature/pictures.slice.js";
...
const PicCard = ({ pic }) => {
  ...
  const handleEdit = () => {
    ...
    // Avec Json Server obligation de remplir tous les champs, même ceux qu'on ne remplace pas car le server écrase à chaque modification
    const data = {
